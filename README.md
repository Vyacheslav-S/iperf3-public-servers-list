...
| iperf3 -c speedtest.wobcom.de :small\_blue\_diamond: | \-R,-6 |     | DE  | Wolfsburg |
...
:small\_blue\_diamond: speedtest.wobcom.de connects to the nearest \*.speedtest.wobcom.de server.
...
https://iperf3serverlist.net/serverlist.json (daily updated)
